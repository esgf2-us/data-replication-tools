<?php
    ...
    $query = 'SELECT dataset,source,requested,completed,status,directories,files,files_transferred,bytes_transferred,faults,rate FROM transfer WHERE destination=\'OLCF\' order by dataset';
    $out = pg_query($query);
    $transfers = array();
